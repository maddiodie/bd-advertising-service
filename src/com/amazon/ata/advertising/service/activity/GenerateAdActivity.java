...
public class GenerateAdActivity {
    ...
    /**
     * Decides on the ad most likely to be clicked on by the provided customer, from the group of
     * ads a customer is eligible to see.
     * @param request Contains the customerId to generate an advertisement for, and the marketplace
     *                id where the ad will be rendered
     * @return the response will contain the generated advertisement. It's content will be an empty
     *         String if no advertisement could be generated.
     */
